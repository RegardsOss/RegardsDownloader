...
public class GetRequest extends Request {
    ...
    protected boolean sendHTTPHeader(HTTPHeader header) {
         ...
         */
        return super.sendHTTPHeader(header) && !StringUtils.equalsIgnoreCase(header.getKey(), HTTPConstants.HEADER_RESPONSE_CONTENT_LENGTH) && !StringUtils
                .equalsIgnoreCase(header.getKey(), HTTPConstants.HEADER_RESPONSE_CONTENT_TYPE);
    }
