...
public class Browser {
    ...
    private void setRequestProperties(final Request sourceRequest, final Request nextRequest, final String refererURL) {
        if (nextRequest != null) {
            ...
            if (sourceRequest != null && StringUtils
                    .startsWithCaseInsensitive(sourceRequest.getURL().getProtocol(), "https")) {
        ...
        while (true) {
            ...
            while (true) {
                try {
                    ...
                    proxyRetryCounter++;
                    if (this.reportConnectException(proxyRetryCounter, e, request) || e instanceof ProxyAuthException
                            && this.updateProxy(proxyRetryCounter, request)) {
                        // reset proxy
