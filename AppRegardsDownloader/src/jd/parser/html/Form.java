...
public class Form {
    ...
    public List<InputField> getInputFieldsByType(final String type) {
        final List<InputField> ret = new ArrayList<InputField>();
        for (final InputField ipf : this.inputfields) {
     ...
     * @return
     */
    public List<KeyValueStringEntry> getRequestVariables() {
