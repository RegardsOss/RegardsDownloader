...
public interface AdvancedConfigInterface extends Linkable {
    ...
    @Deprecated
    public ArrayList<AdvancedConfigEntryDataStorable> list(String pattern, boolean returnDescription,
            boolean returnValues, boolean returnDefaultValues);

    public ArrayList<AdvancedConfigEntryDataStorable> list(String pattern, boolean returnDescription,
            boolean returnValues, boolean returnDefaultValues, boolean returnEnumInfo);
