...
@HostPlugin(revision = "$Revision: 29981 $", interfaceVersion = 2, names = { "easy-share.com", "crocko.com" }, urls = { "sgru3465979hg354uigUNUSED_REGEX879t24uj", "https?://(www\\.)?(easy\\-share|crocko)\\.com/(?!us|en|pt|accounts|billing|f/|mc)([A-Z0-9]+/?|\\d+)" }, flags = { 0, 2 })
