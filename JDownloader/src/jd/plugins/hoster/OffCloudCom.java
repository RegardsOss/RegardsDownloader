...
@HostPlugin(revision = "$Revision: 33840 $", interfaceVersion = 3, names = { "offcloud.com" }, urls = { "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsfs2133" }, flags = { 2 })
public class OffCloudCom extends PluginForHost {
    ...
    public void showAccountDetailsDialog(final Account account) {
        ...
        if (ai != null) {
            ...
            String revision = "$Revision: 33840 $";
