...
@HostPlugin(revision = "$Revision: 33002 $", interfaceVersion = 2, names = { "vidxtreme.to" }, urls = { "https?://(www\\.)?vidxtreme\\.to/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class VidxtremeTo extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://vidxtreme.to";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(vidxtreme\\.to)";
    ...
    // mods: scanInfo [Removed filesize RegExes], doFree[Added additional waittime before download1 form submit]
    // limit-info:
    // protocol: no https
    // captchatype: null
    // other:
    ...
    public VidxtremeTo(PluginWrapper wrapper) {
        super(wrapper);
