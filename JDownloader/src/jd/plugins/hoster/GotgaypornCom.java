...
@HostPlugin(revision = "$Revision: 30880 $", interfaceVersion = 2, names = { "gotgayporn.com" }, urls = { "http://(www\\.)?gotgayporn\\.com/\\d+[a-z0-9\\-]+/" }, flags = { 0 })
public class GotgaypornCom extends PluginForHost {
    ...
    public String getAGBLink() {
        return "http://www.gotgayporn.com/usc_statement";
    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (br.containsHTML(">Sorry we were unable to find any videos") || br.getHttpConnection().getResponseCode() == 404) {
