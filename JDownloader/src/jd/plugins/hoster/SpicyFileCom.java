...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "spicyfile.com" }, urls = { "https?://(www\\.)?spicyfile\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class SpicyFileCom extends PluginForHost {
    ...
    private static final String  MAINTENANCE                  = ">This server is in maintenance mode|>Downloads are temporarily disabled due to site maintenance<";
