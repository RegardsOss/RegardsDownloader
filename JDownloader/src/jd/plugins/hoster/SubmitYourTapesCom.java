...
@HostPlugin(revision = "$Revision: 33533 $", interfaceVersion = 2, names = { "submityourtapes.com" }, urls = { "http://(www\\.)?submityourtapes\\.com/videos/\\d+/[a-z0-9\\-]+\\.html" }, flags = { 0 })
public class SubmitYourTapesCom extends PluginForHost {
    ...
    public String getAGBLink() {
        return "http://www.submityourtapes.com/terms.php";
    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (DLLINK == null) {
            DLLINK = br.getRegex("name=\"FlashVars\" value=\"file=(http.*?)http://(www\\.)?submityourtapes\\.com").getMatch(0);
        }
        if (DLLINK == null) {
            DLLINK = br.getRegex("src=\"(http://[^<>\"]*?)\" type=\\'video/mp4\\'").getMatch(0);
        }
