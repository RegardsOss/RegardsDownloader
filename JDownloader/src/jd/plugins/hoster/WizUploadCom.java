...
@HostPlugin(revision = "$Revision: 33836 $", interfaceVersion = 2, names = { "wizupload.com" }, urls = { "https?://(www\\.)?wizupload\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class WizUploadCom extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://wizupload.com";
    ...
    public WizUploadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "file\"></span>([^<>]*?)<").getMatch(0);
        }
        if (fileInfo[1] == null) {
