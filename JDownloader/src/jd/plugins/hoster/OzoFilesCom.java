...
@HostPlugin(revision = "$Revision: 33002 $", interfaceVersion = 2, names = { "ozofiles.com" }, urls = { "https?://(www\\.)?ozofiles\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class OzoFilesCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://ozofiles.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(ozofiles\\.com|ozofiles\\.me)";
    ...
    public OzoFilesCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        /** Ticket Time */
        String ttt = new Regex(correctedBR, "id=\"countdown_str\">.*?class=\"count\">(\\d+)</span>").getMatch(0);
        if (inValidate(ttt)) {
            ttt = new Regex(correctedBR, "id=\"countdown\"><div class=\"count_cnt\"><span class=\"seconds\">(\\d+)\\s*</span>").getMatch(0);
        }
        if (ttt != null) {
