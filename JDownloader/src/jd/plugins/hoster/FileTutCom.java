...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "filetut.com" }, urls = { "https?://(www\\.)?filetut\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class FileTutCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|<b>Filename:</b></td><td nowrap></td></tr><br>)").matches()) {
