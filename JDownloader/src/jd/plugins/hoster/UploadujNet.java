...
@HostPlugin(revision = "$Revision: 32097 $", interfaceVersion = 3, names = { "uploaduj.net" }, urls = { "http://(?:www\\.)?uploaduj\\.net/[A-Za-z0-9]+/[a-z0-9\\-]+/" }, flags = { 0 })
public class UploadujNet extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        if (br.getHttpConnection().getResponseCode() == 404 || this.br.containsHTML("class=\"glyphicon glyphicon\\-remove\\-sign\"|Błąd 404</")) {
