...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "rosharing.net", "rosharing.com" }, urls = { "https?://(?:www\\.)?(rosharing\\.com|rosharing\\.net|roshare\\.info)/[A-Za-z0-9]+", "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsdgfd32424" }, flags = { 0, 0 })
public class RoSharingCom extends PluginForHost {
    ...
    // mods:
    // limit-info: untested, (free) downloads were impossible
    // protocol: no https
    // captchatype: null
    // other:
    ...
    public String rewriteHost(String host) {
        if ("rosharing.com".equals(getHost()) || "roshare.info".equals(getHost())) {
            if (host == null || "rosharing.com".equals(host) || "roshare.info".equals(host)) {
                return "rosharing.net";
            }
        }
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://rosharing.net";
    private final String         domains                                      = "(rosharing\\.net)";
    ...
    public void correctDownloadLink(final DownloadLink link) {
        ...
        link.setUrlDownload(link.getDownloadURL().replaceAll("(rosharing\\.com|roshare\\.info)/", "rosharing.net/"));
    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        if (available_CHECK_OVER_INFO_PAGE) {
            ...
            filesize = br.getRegex("(?:Filesize|Dimensiune):[\t\n\r ]*?</td>[\t\n\r ]*?<td(?: class=\"responsiveInfoTable\")?>([^<>\"]*?)<").getMatch(0);
        } else {
