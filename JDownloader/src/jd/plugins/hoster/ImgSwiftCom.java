...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "imgswift.com" }, urls = { "https?://(www\\.)?imgswift\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ImgSwiftCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://imgswift.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(imgswift\\.com)";
    ...
    // mods: scanInfo[removed filesize, not needed!]
    // limit-info: chunks = 1 because we re only downloading small files (pictures) here
    // protocol: no https
    // captchatype: null
    // other:
    ...
    public ImgSwiftCom(PluginWrapper wrapper) {
        super(wrapper);
