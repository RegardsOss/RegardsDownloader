...
@HostPlugin(revision = "$Revision: 33809 $", interfaceVersion = 2, names = { "dropapk.com" }, urls = { "https?://(?:www\\.)?dropapk\\.com/[A-Za-z0-9]+" }, flags = { 0 })
public class DropapkCom extends PluginForHost {

    public DropapkCom(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * mods:<br />
     * limit-info: 2016-05-18: no limits at all<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://dropapk.com";
    private final String                   domains                                      = "(dropapk\\.com)";
