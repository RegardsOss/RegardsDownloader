...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "theisozone.com" }, urls = { "(http://(www\\.)?theisozonedecrypted\\.com/dl\\-start/\\d+/(\\d+/)?|xboxisopremiumonly://.+)" }, flags = { 2 })
