...
@HostPlugin(revision = "$Revision: 33357 $", interfaceVersion = 3, names = { "elsfile.com" }, urls = { "https?://(www\\.)?elsfile\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ElsfileCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://elsfile.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(elsfile\\.com)";
    ...
    public ElsfileCom(PluginWrapper wrapper) {
        super(wrapper);
