...
@HostPlugin(revision = "$Revision: 33002 $", interfaceVersion = 3, names = { "uploadocean.com" }, urls = { "https?://(www\\.)?uploadocean\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class UploadoceanCom extends PluginForHost {
    ...
    public UploadoceanCom(PluginWrapper wrapper) {
        super(wrapper);
