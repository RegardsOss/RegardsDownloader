...
@HostPlugin(revision = "$Revision: 33002 $", interfaceVersion = 2, names = { "fileupup.com" }, urls = { "https?://(www\\.)?fileupup\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FileupupCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                  = "http://fileupup.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(fileupup\\.com)";
    /* Linktypes */
    ...
    public FileupupCom(PluginWrapper wrapper) {
        super(wrapper);
