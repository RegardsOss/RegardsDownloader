...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "basicupload.com" }, urls = { "https?://(www\\.)?basicupload\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class BasicUploadCom extends PluginForHost {

    private String               correctedBR                  = "";
    private String               passCode                     = null;
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    // primary website url, take note of redirects
    private static final String  COOKIE_HOST                  = "http://basicupload.com";
    // domain names used within download links.
    private static final String  DOMAINS                      = "(basicupload\\.com)";
    ...
    public BasicUploadCom(PluginWrapper wrapper) {
        super(wrapper);
