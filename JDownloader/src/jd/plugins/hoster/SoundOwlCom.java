...
@HostPlugin(revision = "$Revision: 27227 $", interfaceVersion = 2, names = { "soundowl.com" }, urls = { "http://(www\\.)?soundowl\\.com/track/[a-z0-9]+|http://dl\\.soundowl\\.com/[a-z0-9]+\\.mp3" }, flags = { 0 })
