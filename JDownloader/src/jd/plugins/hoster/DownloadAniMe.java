...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 3, names = { "downloadani.me" }, urls = { "https?://(www\\.)?downloadani\\.me/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
@SuppressWarnings("deprecation")
public class DownloadAniMe extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://downloadani.me";
    // domain names used within download links.
    private final String               DOMAINS                      = "(downloadani\\.me)";
     ...
     * */
    public DownloadAniMe(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();
