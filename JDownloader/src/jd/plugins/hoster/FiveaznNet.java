...
@HostPlugin(revision = "$Revision: 33003 $", interfaceVersion = 3, names = { "5azn.net" }, urls = { "https?://(www\\.)?5azn\\.net/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class FiveaznNet extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://5azn.net";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(5azn\\.net)";
    ...
    public FiveaznNet(PluginWrapper wrapper) {
        super(wrapper);
