...
@HostPlugin(revision = "$Revision: 33842 $", interfaceVersion = 2, names = { "ulnow.com" }, urls = { "https?://(?:www\\.)?ulnow\\.com/[A-Za-z0-9]+" }, flags = { 0 })
public class UlnowCom extends PluginForHost {

    public UlnowCom(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * mods:<br />
     * limit-info: 2016-05-24: No limits at all<br />
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://ulnow.com";
    private final String                   domains                                      = "(ulnow\\.com)";
