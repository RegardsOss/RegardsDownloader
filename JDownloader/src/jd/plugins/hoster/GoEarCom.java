...
@HostPlugin(revision = "$Revision: 25208 $", interfaceVersion = 2, names = { "goear.com" }, urls = { "http://(www\\.)?(goear\\.com/listen/[0-9a-f]+/|youares\\.com/reproducir/[a-z0-9]+/[0-9a-f]+/)" }, flags = { 0 })
