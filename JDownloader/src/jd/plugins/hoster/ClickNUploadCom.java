...
@HostPlugin(revision = "$Revision: 33296 $", interfaceVersion = 2, names = { "clicknupload.link", }, urls = { "https?://(?:www\\.)?clicknupload\\.(?:com|me|link)/(?:vidembed\\-)?[a-z0-9]{12}", }, flags = { 0 })
public class ClickNUploadCom extends antiDDoSForHost {
    ...
    // mods:waitTime [get wait from br instead of correctedBR]; getDllink
    // limit-info:
    // protocol: no https
    ...
    public ClickNUploadCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        /** Ticket Time */
        final String ttt = br.getRegex("id=\"countdown_str\">Please wait <span id=\"[a-z0-9]+\" style=\"[^<>\"]+\">(\\d+)</span>").getMatch(0);
        if (ttt != null) {
