...
@HostPlugin(revision = "$Revision: 33848 $", interfaceVersion = 3, names = { "commons.wikimedia.org" }, urls = { "https?://commons\\.wikimedia\\.org/wiki/File:.+|https?://[a-z]{2}\\.wikipedia\\.org/wiki/[^/]+/media/File:.+" }, flags = { 0 })
