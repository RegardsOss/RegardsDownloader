...
@HostPlugin(revision = "$Revision: 24787 $", interfaceVersion = 2, names = { "gokuai.com" }, urls = { "https?://(www\\.)?gokuai\\.com/f/[A-Za-z0-9]+|gokuais?://(www\\.)?gokuai\\.com/a/[a-zA-Z0-9]{16}/[a-z0-9]{40}" }, flags = { 0 })
