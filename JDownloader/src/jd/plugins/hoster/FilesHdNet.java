...
@HostPlugin(revision = "$Revision: 32593 $", interfaceVersion = 2, names = { "fileshd.net" }, urls = { "https?://(www\\.)?fileshd\\.net/((vidembed\\-)?[a-z0-9]{12}|d/[A-Za-z0-9]+)" }, flags = { 2 })
public class FilesHdNet extends PluginForHost {
    ...
    private static final String            DOMAINS                      = "(fileshd\\.net)";
    ...
    public FilesHdNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        if (new Regex(correctedBR, "(No such file|>File Not Found<|>The file was removed by|Reason for deletion:\n|<h3>File Not Found, Searching For\\s*\\.\\.\\.</h3>)").matches()) {
            throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);
        }
