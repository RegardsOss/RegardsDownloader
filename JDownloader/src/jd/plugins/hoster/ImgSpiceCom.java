...
@HostPlugin(revision = "$Revision: 33379 $", interfaceVersion = 2, names = { "imgspice.com" }, urls = { "https?://(?:www\\.)?imgspice\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class ImgSpiceCom extends PluginForHost {
    ...
    private static final String  COOKIE_HOST                  = "http://imgspice.com";
    private static final String  NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String  NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    // domain names used within download links.
    private static final String  DOMAINS                      = "(imgspice\\.com)";
    ...
    public ImgSpiceCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public String getDllink() {
        ...
        if (dllink == null) {
            ...
            if (dllink == null) {
                dllink = new Regex(correctedBR, "\"(http://[a-z0-9]+\\." + DOMAINS + "/i/[^<>\"]*?)\"").getMatch(0);
            }
            if (dllink == null) {
