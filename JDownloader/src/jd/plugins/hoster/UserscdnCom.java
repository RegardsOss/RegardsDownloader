...
@HostPlugin(revision = "$Revision: 33503 $", interfaceVersion = 3, names = { "userscdn.com" }, urls = { "https?://(?:www\\.)?userscdn\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class UserscdnCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://userscdn.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(userscdn\\.com)";
     ...
     * mods:<br />
     * limit-info: standard limits as website was broken when plugin was made<br />
