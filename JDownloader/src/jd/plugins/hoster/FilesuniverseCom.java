...
@HostPlugin(revision = "$Revision: 33002 $", interfaceVersion = 2, names = { "filesuniverse.com" }, urls = { "https?://(www\\.)?filesuniverse\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FilesuniverseCom extends antiDDoSForHost {
    ...
    private static final String            COOKIE_HOST                  = "http://filesuniverse.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(filesuniverse\\.com)";
    /* Linktypes */
    ...
    @SuppressWarnings("deprecation")
    public FilesuniverseCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, "<b>Filename :</b>([^<>\"]*?)</p>").getMatch(0);
        }
        if (fileInfo[1] == null) {
