...
@HostPlugin(revision = "$Revision: 31990 $", interfaceVersion = 2, names = { "min.us", "minus.com" }, urls = { "cvj84ezu45gj0wojgHZiF238ß3üpj5uUNUSED_REGEX", "http://([a-zA-Z0-9]+\\.)?minusdecrypted\\.com/[A-Za-z0-9\\-_\\.]+" }, flags = { 0, 0 })
