...
@HostPlugin(revision = "$Revision: 25475 $", interfaceVersion = 2, names = { "bing.com", "video.msn.com" }, urls = { "decrypted://bing.com/\\d+", "bteji456z90ubetkmnerlDELETE_MEfhtrjkhrdrfd" }, flags = { 2, 2 })
