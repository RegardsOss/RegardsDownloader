...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "picstream.tv" }, urls = { "https?://(www\\.)?picstream\\.tv/[A-Za-z0-9]+" }, flags = { 0 })
public class PicstreamTv extends PluginForHost {

    public PicstreamTv(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://picstream.tv";
    private final String         domains                                      = "(picstream\\.tv)";
