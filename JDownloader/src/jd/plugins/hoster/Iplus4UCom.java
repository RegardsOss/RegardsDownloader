...
@HostPlugin(revision = "$Revision: 23576 $", interfaceVersion = 2, names = { "iplus4u.com" }, urls = { "http://(www\\.)?iplus4u\\.com/owncloud/public\\.php\\?service=files\\&t=[a-z0-9]{32}" }, flags = { 0 })
