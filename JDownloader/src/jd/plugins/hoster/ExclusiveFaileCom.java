...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 3, names = { "exclusiveloader.com", "exclusivefaile.com" }, urls = { "https?://(www\\.)?(exclusivefaile\\.com|exclusiveloader\\.com)/((vid)?embed-)?[a-z0-9]{12}", "NOTUSED_4812jdmSDusd4aSAJD415uauadfjadafasadx" }, flags = { 2, 0 })
