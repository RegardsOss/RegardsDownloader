...
@HostPlugin(revision = "$Revision: 28035 $", interfaceVersion = 2, names = { "nuvid.com" }, urls = { "http://(www\\.)?nuvid\\.com/(video|embed)/\\d+" }, flags = { 0 })
public class NuVidCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        final String linkPart = br.getRegex("\\'http://www\\.nuvid\\.com(/player_config/\\?(check_speed=.%26)?t=.*?)\\'\\);").getMatch(0);
