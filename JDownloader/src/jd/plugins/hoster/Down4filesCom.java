...
@HostPlugin(revision = "$Revision: 33002 $", interfaceVersion = 3, names = { "down4files.com" }, urls = { "https?://(www\\.)?down4files\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class Down4filesCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://down4files.com";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(down4files\\.com)";
    /*
    ...
    // mods: doFree[download1-form modifications]
    // limit-info:
    // protocol: no https
    ...
    @SuppressWarnings("deprecation")
    public Down4filesCom(PluginWrapper wrapper) {
        super(wrapper);
