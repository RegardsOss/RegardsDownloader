...
@HostPlugin(revision = "$Revision: 33839 $", interfaceVersion = 3, names = { "imgoutlet.com" }, urls = { "https?://(?:www\\.)?imgoutlet\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ImgoutletCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://imgoutlet.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(imgoutlet\\.com)";
    ...
    public ImgoutletCom(PluginWrapper wrapper) {
        super(wrapper);
