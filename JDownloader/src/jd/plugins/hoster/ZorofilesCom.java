...
@HostPlugin(revision = "$Revision: 33002 $", interfaceVersion = 3, names = { "zorofiles.com" }, urls = { "https?://(www\\.)?zorofiles\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ZorofilesCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://zorofiles.com";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(zorofiles\\.com)";
    /*
    ...
    // mods: doFree[Some download1form changes]
    // limit-info:
    // protocol: no https
    // captchatype: null
    // other:
    ...
    @SuppressWarnings("deprecation")
    public ZorofilesCom(PluginWrapper wrapper) {
        super(wrapper);
        ...
        if (dllink == null) {
            ...
            if (download1 != null) {
                ...
                if (!download1.hasInputFieldByName("method_free")) {
                    download1.put("method_free", "Slow Speed Download");
                }
                /* end of backward compatibility */
