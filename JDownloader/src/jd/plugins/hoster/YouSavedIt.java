...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "yousaved.it" }, urls = { "https?://(www\\.)?yousaved\\.it/[A-Za-z0-9]+" }, flags = { 2 })
public class YouSavedIt extends PluginForHost {

    public YouSavedIt(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://yousaved.it";
    private final String         domains                                      = "(yousaved\\.it)";
