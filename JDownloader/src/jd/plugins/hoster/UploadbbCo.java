...
@HostPlugin(revision = "$Revision: 31456 $", interfaceVersion = 2, names = { "uploadbb.co" }, urls = { "http://(www\\.)?uploadbb\\.co/(v/)?[A-Za-z0-9]+" }, flags = { 0 })
public class UploadbbCo extends PluginForHost {
    ...
    /* DEV NOTES */
    // YetiShareBasic Version ???-psp heavily modified!
    // protocol: no https
    // other:
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (br.containsHTML(">Le fichier a été supprimé en raison de problèmes") || br.getHttpConnection().getResponseCode() == 404) {
