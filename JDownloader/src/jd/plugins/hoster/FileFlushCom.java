...
@HostPlugin(revision = "$Revision: 29981 $", interfaceVersion = 2, names = { "fileflush.com" }, urls = { "http://(www\\.)?fileflush\\.com/((\\?d|download\\.php\\?id)=[A-Z0-9]+|((en|ru|fr|es|de)/)?file/[0-9]+/)" }, flags = { 2 })
