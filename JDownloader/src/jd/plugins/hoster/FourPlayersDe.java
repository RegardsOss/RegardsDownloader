...
@HostPlugin(revision = "$Revision: 30536 $", interfaceVersion = 2, names = { "4players.de" }, urls = { "http://(www\\.)?4players\\.de/4players\\.php/download_info/Downloads/Download/\\d+/[^<>\"]*?\\.html" }, flags = { 0 })
