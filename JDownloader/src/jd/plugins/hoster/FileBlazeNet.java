...
@HostPlugin(revision = "$Revision: 26050 $", interfaceVersion = 2, names = { "fileblaze.net" }, urls = { "http://(www|stream|betastageflash)\\.fileblaze\\.net/soundblaze/(download/file|external/music;jsessionid=[0-9A-F]+)\\?key=[0-9a-z\\-]+" }, flags = { 0 })
