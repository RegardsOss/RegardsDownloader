...
@HostPlugin(revision = "$Revision: 33255 $", interfaceVersion = 2, names = { "xxxaporn.com" }, urls = { "http://(www\\.)?(xxxaporndecrypted\\.com/\\d+/[A-Za-z0-9\\-_]+\\.html|media\\.xxxaporn\\.com/video/\\d+)" }, flags = { 0 })
