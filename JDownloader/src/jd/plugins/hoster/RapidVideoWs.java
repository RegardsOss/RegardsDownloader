...
@HostPlugin(revision = "$Revision: 33839 $", interfaceVersion = 2, names = { "rapidvideo.ws", "xvidstage.com" }, urls = { "https?://(www\\.)?rapidvideo\\.ws/(embed\\-)?[a-z0-9]{12}", "https?://(www\\.)?xvidstage\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0, 0 })
public class RapidVideoWs extends PluginForHost {
    ...
    public RapidVideoWs(PluginWrapper wrapper) {
        super(wrapper);
