...
@HostPlugin(revision = "$Revision: 31871 $", interfaceVersion = 2, names = { "file-upload.net" }, urls = { "http://(www\\.|en\\.)?file\\-upload\\.net/((member/){0,1}download\\-\\d+/(.*?)\\.html|view\\-\\d+/(.*?)\\.html|member/view_\\d+_(.*?)\\.html|member/data3\\.php\\?user=(.*?)\\&name=(.*))" }, flags = { 0 })
