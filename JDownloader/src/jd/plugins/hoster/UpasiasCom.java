...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "upasias.com" }, urls = { "https?://(www\\.)?upasias\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class UpasiasCom extends PluginForHost {
    ...
    public UpasiasCom(PluginWrapper wrapper) {
        super(wrapper);
