...
@HostPlugin(revision = "$Revision: 33555 $", interfaceVersion = 3, names = { "depic.me" }, urls = { "https?://(?:www\\.)?depic\\.me/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class DepicMe extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://depic.me";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(depic\\.me)";
    ...
    public DepicMe(PluginWrapper wrapper) {
        super(wrapper);
