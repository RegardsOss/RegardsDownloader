...
@HostPlugin(revision = "$Revision: 33555 $", interfaceVersion = 3, names = { "mydirtyhobby.com" }, urls = { "https?://(?:www\\.)?mydirtyhobby\\.com/profil/\\d+[A-Za-z0-9\\-]+/videos/\\d+[A-Za-z0-9\\-]+" }, flags = { 2 })
