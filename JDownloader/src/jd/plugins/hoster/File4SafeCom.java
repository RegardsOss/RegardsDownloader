...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "file4safe.com" }, urls = { "https?://(www\\.)?file4safe\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class File4SafeCom extends PluginForHost {
    ...
    private static final String  DOMAINS                      = "(file4safe\\.com)";
