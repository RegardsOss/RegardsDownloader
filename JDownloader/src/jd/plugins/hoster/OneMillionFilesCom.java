...
@HostPlugin(revision = "$Revision: 31059 $", interfaceVersion = 2, names = { "onemillionfiles.com" }, urls = { "http://(www\\.)?onemillionfiles\\.com/index\\.php/files/get/[A-Za-z0-9_\\-]+" }, flags = { 0 })
