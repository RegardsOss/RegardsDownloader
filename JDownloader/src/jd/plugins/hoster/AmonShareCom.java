...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "amonshare.com" }, urls = { "https?://(www\\.)?amonshare\\.com/[A-Za-z0-9]+" }, flags = { 2 })
public class AmonShareCom extends PluginForHost {

    public AmonShareCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://amonshare.com";
    private final String         domains                                      = "(amonshare\\.com)";
