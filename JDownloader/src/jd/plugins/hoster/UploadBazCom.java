...
@HostPlugin(revision = "$Revision: 32968 $", interfaceVersion = 3, names = { "uploadbaz.com" }, urls = { "https?://(www\\.)?uploadbaz\\.com/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 2 })
@SuppressWarnings("deprecation")
public class UploadBazCom extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://uploadbaz.com";
    // domain names used within download links.
    private final String               DOMAINS                      = "(uploadbaz\\.com)";
    ...
    // DEV NOTES
    // XfileShare Version 3.0.8.5-mod
