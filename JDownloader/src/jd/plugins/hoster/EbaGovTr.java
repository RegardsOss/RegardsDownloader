...
@HostPlugin(revision = "$Revision: 23680 $", interfaceVersion = 2, names = { "eba.gov.tr" }, urls = { "http://(www\\.)?(eba\\.gov\\.tr/(video/izle/[a-z0-9]+|ses/dinle/[a-z0-9]+|gorsel/bak/[a-z0-9]+)|ebadecrypted\\.gov\\.tr/dergi/goster/\\d+)" }, flags = { 0 })
