...
@HostPlugin(revision = "$Revision: 33335 $", interfaceVersion = 2, names = { "kingfiles.net" }, urls = { "https?://(?:www\\.)?kingfiles\\.net/[A-Za-z0-9]+" }, flags = { 2 })
public class KingfilesNet extends PluginForHost {
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://kingfiles.net";
