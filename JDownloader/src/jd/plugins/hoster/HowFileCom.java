...
@HostPlugin(revision = "$Revision: 27192 $", interfaceVersion = 2, names = { "howfile.com" }, urls = { "http://(www\\.)?howfile\\.com/file/[a-z0-9]+/[a-z0-9]+" }, flags = { 0 })
public class HowFileCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink link) throws IOException, PluginException {
        ...
        if (filename == null) {
            filename = br.getRegex("<title>(.*?) \\- howfile\\.com \\- Free File Hosting and Sharing, Unlimit Download </title>").getMatch(0);
        }
        String filesize = br.getRegex("<b>File Size:</b>\\&nbsp;\\&nbsp;\\&nbsp;\\&nbsp;([^<>\"]*?)<br>").getMatch(0);
        if (filesize == null) {
