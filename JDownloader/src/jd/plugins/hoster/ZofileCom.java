...
@HostPlugin(revision = "$Revision: 33315 $", interfaceVersion = 3, names = { "zofile.com" }, urls = { "https?://(www\\.)?zofile\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ZofileCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://zofile.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(zofile\\.(com|click))";
     ...
     * mods: getDllink[Other dllink RegEx]<br />
     * limit-info:<br />
    ...
    public ZofileCom(PluginWrapper wrapper) {
        super(wrapper);
