...
@HostPlugin(revision = "$Revision: 33003 $", interfaceVersion = 3, names = { "hulkimge.com" }, urls = { "https?://(www\\.)?hulkimge\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class HulkimageCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://hulkimge.com";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(hulkimge\\.com)";
    ...
    public HulkimageCom(PluginWrapper wrapper) {
        super(wrapper);
