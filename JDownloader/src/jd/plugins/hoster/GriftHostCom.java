...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "grifthost.com" }, urls = { "https?://(www\\.)?grifthost\\.com/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class GriftHostCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://grifthost.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(grifthost\\.com)";
    ...
    // mods: special VIDEOHOSTER handling, decodeDownloadLink [regex]
    ...
    public GriftHostCom(PluginWrapper wrapper) {
        super(wrapper);
