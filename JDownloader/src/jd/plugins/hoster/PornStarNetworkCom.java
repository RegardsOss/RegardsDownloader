...
@HostPlugin(revision = "$Revision: 33763 $", interfaceVersion = 2, names = { "pornstarnetwork.com" }, urls = { "https?://(?:www\\.)?pornstarnetwork\\.com/video/(?:(?:[a-z0-9\\-_]+)?\\d+\\.html|embed\\?id=\\d+)" }, flags = { 0 })
