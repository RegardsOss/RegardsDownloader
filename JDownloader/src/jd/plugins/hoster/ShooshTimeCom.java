...
@HostPlugin(revision = "$Revision: 31658 $", interfaceVersion = 2, names = { "shooshtime.com" }, urls = { "http://(www\\.)?shooshtime\\.com/(videos/[A-Za-z0-9\\-_]+/[A-Za-z0-9\\-_]+/|webcam\\-girls/[A-Za-z0-9\\-_]+/)" }, flags = { 0 })
