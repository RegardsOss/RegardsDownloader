...
@HostPlugin(revision = "$Revision: 18112 $", interfaceVersion = 2, names = { "funonly.net" }, urls = { "http://(www\\.)?funonly\\.net/funny_videos\\.aspx/funny_video~[A-Za-z0-9\\-_]+/[A-Za-z0-9\\-_]+/[A-Za-z0-9\\-_]+/video_type~flash/" }, flags = { 0 })
