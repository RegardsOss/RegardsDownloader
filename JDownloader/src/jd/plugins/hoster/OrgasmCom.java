...
@HostPlugin(revision = "$Revision: 21971 $", interfaceVersion = 2, names = { "orgasm.com" }, urls = { "http://(www\\.)?orgasm\\.com/(movies(/recent/[\\w\\+\\%]+)?\\?id=/video/\\d+/|movies\\?id=%2Fvideo%2F\\d+%2F)" }, flags = { 32 })
