...
@HostPlugin(revision = "$Revision: 25113 $", interfaceVersion = 2, names = { "droplr.com" }, urls = { "https?://(www\\.)?(droplr\\.com|d\\.pr)/(f/[A-Za-z0-9]+|[A-Za-z0-9]+/[A-Za-z0-9]+/[A-Za-z0-9]+)" }, flags = { 0 })
