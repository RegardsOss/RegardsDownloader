...
@HostPlugin(revision = "$Revision: 33843 $", interfaceVersion = 3, names = { "wi.to" }, urls = { "https?://(?:www\\.)?(?:wi|moviecloud)\\.to/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class WiTo extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://wi.to";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "((?:wi|moviecloud)\\.to)";
     ...
     * mods: doFree[download1 Form fix "method_free"], requestFileInformation[extra offline handling for old YetiShare links]<br />
     * limit-info:<br />
    ...
    public String rewriteHost(String host) {
        if ("moviecloud.to".equals(getHost())) {
            if (host == null || "moviecloud.to".equals(host)) {
                return "wi.to";
            }
        }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        setFUID(link);
        if (this.fuid == null) {
            /* Extra offline handling for links of their previously used script "YetiShare" */
