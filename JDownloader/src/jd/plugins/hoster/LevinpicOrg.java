...
@HostPlugin(revision = "$Revision: 33739 $", interfaceVersion = 3, names = { "levinpic.org" }, urls = { "https?://(?:www\\.)?levinpic\\.org/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class LevinpicOrg extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://levinpic.org";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(levinpic\\.org)";
    ...
    public LevinpicOrg(PluginWrapper wrapper) {
        super(wrapper);
