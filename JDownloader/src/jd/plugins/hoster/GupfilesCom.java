...
@HostPlugin(revision = "$Revision: 33002 $", interfaceVersion = 3, names = { "gupfiles.com" }, urls = { "https?://(www\\.)?gupfiles\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class GupfilesCom extends PluginForHost {
    ...
    @SuppressWarnings("deprecation")
    public GupfilesCom(PluginWrapper wrapper) {
        super(wrapper);
