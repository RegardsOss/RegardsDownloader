...
@HostPlugin(revision = "$Revision: 29641 $", interfaceVersion = 2, names = { "files.com" }, urls = { "http://(www\\.)?files\\.(com|co\\.uk|de|fr|com\\.au|at|com\\.sq|co\\.hu)/shared/[a-z0-9]+/" }, flags = { 0 })
