...
@HostPlugin(revision = "$Revision: 31950 $", interfaceVersion = 2, names = { "girlfriendvideos.com" }, urls = { "http://(www\\.)?girlfriendvideos\\.com/members/[a-z]/[a-z0-9\\-_]+/\\d+\\.php" }, flags = { 0 })
