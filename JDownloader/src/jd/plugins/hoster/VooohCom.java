...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "voooh.com" }, urls = { "https?://(www\\.)?voooh\\.com/[A-Za-z0-9]+" }, flags = { 0 })
public class VooohCom extends PluginForHost {
    ...
    /* Basic constants */
    private final String         mainpage                                     = "http://voooh.com";
    private final String         domains                                      = "(voooh\\.com)";
