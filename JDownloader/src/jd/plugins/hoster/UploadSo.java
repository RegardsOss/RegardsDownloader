...
@HostPlugin(revision = "$Revision: 33808 $", interfaceVersion = 3, names = { "upload.so" }, urls = { "https?://(?:www\\.)?(?:uploadshub\\.com|upload\\.so)/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class UploadSo extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "https://upload.so";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(uploadshub\\.com|upload\\.so)";
    ...
    public String rewriteHost(String host) {
        if ("uploadshub.com".equals(getHost())) {
            if (host == null || "uploadshub.com".equals(host)) {
                return "upload.so";
            }
        }
    ...
    public UploadSo(PluginWrapper wrapper) {
        super(wrapper);
