...
@HostPlugin(revision = "$Revision: 33560 $", interfaceVersion = 3, names = { "filescdn.com" }, urls = { "https?://(www\\.)?filescdn\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class FilescdnCom extends PluginForHost {
    ...
    public FilescdnCom(PluginWrapper wrapper) {
        super(wrapper);
