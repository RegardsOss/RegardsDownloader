...
@HostPlugin(revision = "$Revision: 31963 $", interfaceVersion = 2, names = { "vids.myspace.com" }, urls = { "https?://(www\\.)?(myspace\\.com/(([a-z0-9\\-_\\.]+/)?video/[a-z0-9\\-_]+/\\d+|[a-z0-9\\-_]+/music/song/[a-z0-9\\-_\\.]+)|mediaservices\\.myspace\\.com/services/media/embed\\.aspx/m=\\d+)" }, flags = { 0 })
