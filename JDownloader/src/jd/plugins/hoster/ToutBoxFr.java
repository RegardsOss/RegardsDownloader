...
@HostPlugin(revision = "$Revision: 32821 $", interfaceVersion = 2, names = { "partageurs.com", "toutbox.fr" }, urls = { "http://(www\\.)?toutboxdecrypted\\.fr/\\d+", "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsdgfd32424" }, flags = { 2, 2 })
