...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "uplod.ir" }, urls = { "https?://(www\\.)?uplod\\.ir/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class UplodIr extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                  = "http://uplod.ir";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(uplod\\.ir)";
    ...
    public UplodIr(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private void waitTime(long timeBefore, final DownloadLink downloadLink) throws PluginException {
        ...
        if (ttt == null) {
            ttt = new Regex(correctedBR, ">(\\d+)</span> seconds").getMatch(0);
        }
        if (ttt != null) {
