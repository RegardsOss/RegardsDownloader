...
@HostPlugin(revision = "$Revision: 33002 $", interfaceVersion = 2, names = { "hdvid.tv" }, urls = { "https?://(www\\.)?hdvid\\.tv/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class HdvidTv extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://hdvid.tv";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(hdvid\\.tv)";
    ...
    // mods: removed filesize, deactivated altAvailablecheck, added download1 pre-download-waittime, waitTime[Added other RegEx]
    // limit-info:
    // protocol: no https
    // captchatype: null
    // other:
    ...
    public HdvidTv(PluginWrapper wrapper) {
        super(wrapper);
