...
@HostPlugin(revision = "$Revision: 27019 $", interfaceVersion = 2, names = { "animeuploads.com", "cizgifilmlerizle.com" }, urls = { "http://(www\\.)?animeuploads\\.com/embed\\.php\\?file=.+", "http://(www\\.)?cizgifilmlerizle\\.com/embed\\.php\\?file=.+" }, flags = { 0, 0 })
