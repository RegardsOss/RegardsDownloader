...
@HostPlugin(revision = "$Revision: 33391 $", interfaceVersion = 3, names = { "save.tv" }, urls = { "https?://(?:www\\.)?save\\.tv/STV/M/obj/(?:archive/VideoArchiveDetails|TC/SendungsDetails)\\.cfm\\?TelecastID=\\d+|https?://[A-Za-z0-9\\-]+\\.save\\.tv/\\d+_\\d+_.+" }, flags = { 2 })
public class SaveTv extends PluginForHost {
    ...
    public void showAccountDetailsDialog(final Account account) {
        ...
        if (ai != null) {
            ...
            String revision = "$Revision: 33391 $";
            try {
