...
@HostPlugin(revision = "$Revision: 33003 $", interfaceVersion = 3, names = { "megaloads.org" }, urls = { "https?://(www\\.)?megaloads\\.org/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class MegaloadsOrg extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://megaloads.org";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(megaloads\\.org)";
    ...
    public MegaloadsOrg(PluginWrapper wrapper) {
        super(wrapper);
