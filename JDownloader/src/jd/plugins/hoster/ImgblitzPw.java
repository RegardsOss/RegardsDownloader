...
@HostPlugin(revision = "$Revision: 33560 $", interfaceVersion = 3, names = { "imgblitz.pw" }, urls = { "https?://(www\\.)?imgblitz\\.pw/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ImgblitzPw extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://imgblitz.pw";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(imgblitz\\.pw)";
    ...
    public ImgblitzPw(PluginWrapper wrapper) {
        super(wrapper);
