...
@HostPlugin(revision = "$Revision: 33667 $", interfaceVersion = 3, names = { "imagetwist.com" }, urls = { "https?://(?:www\\.)?(?:imagetwist|croea)\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ImagetwistCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://imagetwist.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(imagetwist\\.com)";
    ...
    public ImagetwistCom(PluginWrapper wrapper) {
        super(wrapper);
