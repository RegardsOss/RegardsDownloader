...
@HostPlugin(revision = "$Revision: 33738 $", interfaceVersion = 2, names = { "1filesharing.com" }, urls = { "https?://(?:www\\.)?1filesharing\\.com/[A-Za-z0-9]+" }, flags = { 0 })
public class OneFilesharingCom extends PluginForHost {

    public OneFilesharingCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    /* Basic constants */
    private final String                   mainpage                                     = "http://1filesharing.com";
    private final String                   domains                                      = "(1filesharing\\.com)";
