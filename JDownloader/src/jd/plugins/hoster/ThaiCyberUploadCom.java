...
@HostPlugin(revision = "$Revision: 29154 $", interfaceVersion = 2, names = { "thaicyberupload.com" }, urls = { "http://(www\\.)?(thaicyberupload\\.com/get/|data\\d+\\.thaicyberupload\\.com/dl/)[A-Za-z0-9]+" }, flags = { 0 })
