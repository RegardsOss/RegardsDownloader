...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "ydownload.org" }, urls = { "https?://(www\\.)?ydownload\\.org/[a-z0-9]{12}" }, flags = { 0 })
public class YDownloadOrg extends PluginForHost {

    private String               correctedBR                  = "";
    private static final String  PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    private final String         COOKIE_HOST                  = "http://ydownload.org";
    ...
    public YDownloadOrg(PluginWrapper wrapper) {
        super(wrapper);
