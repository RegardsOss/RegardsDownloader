...
@HostPlugin(revision = "$Revision: 33549 $", interfaceVersion = 2, names = { "exashare.com" }, urls = { "https?://(?:www\\.)?(?:exashare\\.com|dowed\\.info|bojem3a\\.info)/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
