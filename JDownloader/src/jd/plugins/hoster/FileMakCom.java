...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "filemac.com", "filekom.com" }, urls = { "https?://(www\\.)?(filemac|filekom)\\.com/[a-z0-9]{12}", "redhgz58opjgfr9cnfmj8gfvDELETEMEfvcjehgonvdqsxwdczjli8" }, flags = { 0, 0 })
