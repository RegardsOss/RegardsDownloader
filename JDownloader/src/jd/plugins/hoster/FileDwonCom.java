...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "filedwon.info", "filedwon.com" }, urls = { "https?://(www\\.)?filedwon\\.(com|net|info)/[a-z0-9]{12}", "589ut90j59ujktojhzDELETE_MErf56uj43zgfjz" }, flags = { 2, 0 })
