...
@HostPlugin(revision = "$Revision: 23474 $", interfaceVersion = 2, names = { "indowebster.com" }, urls = { "http://(www\\.)?(files\\.)?indowebster\\.com/(download/(files|audio|video)/.+|[^\\s]+\\.html)" }, flags = { 0 })
