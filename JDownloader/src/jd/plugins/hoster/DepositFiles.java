...
@HostPlugin(revision = "$Revision: 33608 $", interfaceVersion = 3, names = { "depositfiles.com" }, urls = { "https?://(www\\.)?(depositfiles\\.(com|org)|dfiles\\.(eu|ru))(/\\w{1,3})?/files/[\\w]+" }, flags = { 2 })
public class DepositFiles extends antiDDoSForHost {
    ...
    public void setLangtoGer() throws IOException {
        br.setCookie(MAINPAGE.get(), "lang_current", "de");
    }
