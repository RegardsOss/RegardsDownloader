...
@HostPlugin(revision = "$Revision: 33002 $", interfaceVersion = 2, names = { "mrfile.co" }, urls = { "https?://(www\\.)?mrfile\\.co/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class MrfileCo extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://mrfile.co";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(mrfile\\.co)";
    /* Linktypes */
    ...
    // mods:
    // limit-info: untested, unstable servers
    // protocol: no https
    // captchatype: untested, unstable servers
    // other:
    ...
    @SuppressWarnings("deprecation")
    public MrfileCo(PluginWrapper wrapper) {
        super(wrapper);
