...
@HostPlugin(revision = "$Revision: 32594 $", interfaceVersion = 2, names = { "mp4upload.com" }, urls = { "https?://(www\\.)?mp4upload\\.com/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class Mp4UploadCom extends PluginForHost {
    ...
    // mods: allowed other embed links
    // non account: 2 * 1
    // free account: chunks * maxdls
    // premium account: chunks * maxdls
    // protocol: no https
    // captchatype: null
    // other: those are their embedded videolinks:
    // http://www.mp4upload.com/embed-VIDEOID.html
    ...
    public Mp4UploadCom(PluginWrapper wrapper) {
        super(wrapper);
