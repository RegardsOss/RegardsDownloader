...
@HostPlugin(revision = "$Revision: 27552 $", interfaceVersion = 2, names = { "1000eb.com" }, urls = { "http://(www\\.)?1000eb\\.com/(?!myspace_|upload|bulletin_detail_\\d+|chance|copyrights|agreements|faq|contactus|aboutus|jounus|reportbadinformation)[a-z0-9]+" }, flags = { 0 })
