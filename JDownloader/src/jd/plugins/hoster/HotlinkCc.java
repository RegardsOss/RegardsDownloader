...
@HostPlugin(revision = "$Revision: 33503 $", interfaceVersion = 3, names = { "hotlink.cc" }, urls = { "https?://(?:www\\.)?hotlink\\.cc/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class HotlinkCc extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://hotlink.cc";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(hotlink\\.cc)";
     ...
     * mods: getDllink, waitTime, correctBR<br />
     * limit-info:<br />
    ...
    public HotlinkCc(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String getDllink() {
        ...
        if (dllink == null) {
            ...
            if (inValidate(dllink)) {
                ...
                if (dllink != null && dllink.contains("/images/")) {
                    /* Special: filter invalid urls */
                    dllink = null;
                }
            }
        }
    ...
    private void waitTime(final DownloadLink downloadLink, final long timeBefore) throws PluginException {
        ...
        if (ttt == null) {
            /* Special: new RegEx */
            ttt = new Regex(correctedBR, ">Wait: <span class=\"[^\"]+\"><b>(\\d+)</b>").getMatch(0);
        }
        if (ttt != null) {
