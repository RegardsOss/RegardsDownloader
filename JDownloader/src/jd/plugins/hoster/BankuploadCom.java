...
@HostPlugin(revision = "$Revision: 33560 $", interfaceVersion = 3, names = { "bankupload.com" }, urls = { "https?://(www\\.)?bankupload\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class BankuploadCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://bankupload.com";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(bankupload\\.com)";
    ...
    public BankuploadCom(PluginWrapper wrapper) {
        super(wrapper);
