...
@HostPlugin(revision = "$Revision: 33002 $", interfaceVersion = 3, names = { "thevideos.tv" }, urls = { "https?://(www\\.)?thevideos\\.tv/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ThevideosTv extends PluginForHost {
    ...
    private static final String            DOMAINS                         = "(thevideos\\.tv)";
    /*
    ...
    @SuppressWarnings("deprecation")
    public ThevideosTv(PluginWrapper wrapper) {
        super(wrapper);
