...
@HostPlugin(revision = "$Revision: 33002 $", interfaceVersion = 2, names = { "fileweed.net" }, urls = { "https?://(www\\.)?fileweed\\.net/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class FileweedNet extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                   = "http://fileweed.net";
    private static final String            NICE_HOST                     = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty             = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                       = "(fileweed\\.net)";
    /*
    ...
    @SuppressWarnings("deprecation")
    public FileweedNet(PluginWrapper wrapper) {
        super(wrapper);
    ...
    private String[] scanInfo(final String[] fileInfo) {
        ...
        if (fileInfo[0] == null) {
            fileInfo[0] = new Regex(correctedBR, ":\\d+/d/[^/]+/([^<>\"]*?)\\'\\);").getMatch(0);
        }
        if (fileInfo[0] == null) {
