...
@HostPlugin(revision = "$Revision: 33900 $", interfaceVersion = 3, names = { "uploadcoins.com" }, urls = { "https?://(?:www\\.)?uploadcoins\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class UploadcoinsCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://uploadcoins.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(uploadcoins\\.com)";
    ...
    public UploadcoinsCom(PluginWrapper wrapper) {
        super(wrapper);
