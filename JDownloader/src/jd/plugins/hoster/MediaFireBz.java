...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 3, names = { "mediafire.bz" }, urls = { "https?://(www\\.)?mediafire\\.bz/((vid)?embed-)?[a-z0-9]{12}" }, flags = { 0 })
@SuppressWarnings("deprecation")
public class MediaFireBz extends PluginForHost {

    // Site Setters
    // primary website url, take note of redirects
    private final String               COOKIE_HOST                  = "http://mediafire.bz";
    // domain names used within download links.
    private final String               DOMAINS                      = "(mediafire\\.bz)";
     ...
     * */
    public MediaFireBz(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();
