...
@HostPlugin(revision = "$Revision: 33775 $", interfaceVersion = 3, names = { "sbupload.com" }, urls = { "https?://(?:www\\.)?sbupload\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class SbuploadCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                        = "http://sbupload.com";
    private static final String            NICE_HOST                          = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty                  = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                            = "(sbupload\\.com)";
