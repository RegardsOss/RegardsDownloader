...
@HostPlugin(revision = "$Revision: 33002 $", interfaceVersion = 2, names = { "zstream.to" }, urls = { "https?://(www\\.)?zstream\\.to/(embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ZstreamTo extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                  = "http://zstream.to";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(zstream\\.to)";
    /* Linktypes */
    ...
    private static final int               FREE_MAXCHUNKS               = -6;
    ...
    // mods: waittime before download1
    // limit-info:
    // protocol: no https
    // captchatype: null
    // other:
    ...
    public ZstreamTo(PluginWrapper wrapper) {
        super(wrapper);
