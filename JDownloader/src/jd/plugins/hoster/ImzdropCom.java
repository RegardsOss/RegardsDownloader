...
@HostPlugin(revision = "$Revision: 33003 $", interfaceVersion = 3, names = { "imzdrop.com" }, urls = { "https?://(www\\.)?imzdrop\\.com/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class ImzdropCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://imzdrop.com";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(imzdrop\\.com)";
    ...
    public ImzdropCom(PluginWrapper wrapper) {
        super(wrapper);
