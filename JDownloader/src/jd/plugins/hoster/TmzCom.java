...
@HostPlugin(revision = "$Revision: 23484 $", interfaceVersion = 2, names = { "tmz.com" }, urls = { "http://(www\\.|m\\.)?tmz\\.com/videos/[A-Za-z0-9\\-_]+" }, flags = { 0 })
public class TmzCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(final DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (filename == null) filename = br.getRegex("class=\"main-title video-title\" itemprop=\"name\">([^<>\"]*?)<").getMatch(0);
