...
@HostPlugin(revision = "$Revision: 33537 $", interfaceVersion = 3, names = { "clipfish.de", "dooloop.tv" }, urls = { "http://(?:www\\.)?clipfish\\.de/(?:.*?channel/\\d+/video/\\d+|video/\\d+(?:/.+)?|special/.*?/video/\\d+|musikvideos/video/\\d+(?:/.+)?)", "https?://(?:www\\.)?dooloop\\.tv/video/\\d+/[A-Za-z0-9]+" }, flags = { 0, 0 })
