...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "1000shared.com" }, urls = { "https?://(www\\.)?1000shared\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class OnethousandSharedCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://1000shared.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(1000shared\\.com)";
    ...
    public OnethousandSharedCom(PluginWrapper wrapper) {
        super(wrapper);
