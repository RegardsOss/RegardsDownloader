...
@HostPlugin(revision = "$Revision: 31871 $", interfaceVersion = 2, names = { "googlegroups.com" }, urls = { "http://[\\w\\.]*?googlegroups\\.com/web/.*" }, flags = { 0 })
public class GoogleGroups extends PluginForHost {
    ...
    // @Override
    /*
     * public String getVersion() { return getVersion("$Revision: 31871 $"); }
     */
