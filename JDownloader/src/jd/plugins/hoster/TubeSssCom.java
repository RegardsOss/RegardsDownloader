...
@HostPlugin(revision = "$Revision: 31977 $", interfaceVersion = 2, names = { "tubesss.com" }, urls = { "http://(www\\.)?tubesssdecrypted\\.com/videos/\\d+/.*?\\.html" }, flags = { 0 })
public class TubeSssCom extends PluginForHost {
    ...
    public AvailableStatus requestFileInformation(DownloadLink downloadLink) throws IOException, PluginException {
        ...
        if (filename == null || DLLINK == null || DLLINK.equals("")) {
