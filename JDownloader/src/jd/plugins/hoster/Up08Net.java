...
@HostPlugin(revision = "$Revision: 33681 $", interfaceVersion = 3, names = { "up08.net" }, urls = { "https?://(www\\.)?up08\\.net/(?:embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
public class Up08Net extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                     = "http://up08.net";
    private static final String            NICE_HOST                       = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty               = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                         = "(up08\\.net)";
    ...
    public Up08Net(PluginWrapper wrapper) {
        super(wrapper);
