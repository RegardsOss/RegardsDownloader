...
@HostPlugin(revision = "$Revision: 31670 $", interfaceVersion = 3, names = { "tookapic.com" }, urls = { "https?://stock\\.tookapic\\.com/photos/\\d+" }, flags = { 0 })
public class TookapicCom extends PluginForHost {
    ...
    public String getAGBLink() {
        return "https://tookapic.com/terms";
    }
