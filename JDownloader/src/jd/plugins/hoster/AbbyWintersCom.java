...
@HostPlugin(revision = "$Revision: 25467 $", interfaceVersion = 2, names = { "abbywinters.com" }, urls = { "http://(www\\.)?abbywinters\\.com/shoot/[a-z0-9\\-_]+/(images/stills/[a-z0-9\\-_]+|videos/video/clip)" }, flags = { 2 })
