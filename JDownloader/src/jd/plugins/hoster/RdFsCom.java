...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 3, names = { "rd-fs.com", "flowhot.info" }, urls = { "https?://(www\\.)?(rd-fs\\.com|flowhot\\.info)/[a-z0-9]{12}", "dgzkj65u8efrj6hgDELETEME467zubvr4uijm" }, flags = { 0, 0 })
