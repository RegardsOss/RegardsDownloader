...
@HostPlugin(revision = "$Revision: 30273 $", interfaceVersion = 2, names = { "uploadingit.com" }, urls = { "http://(www\\.)?uploadingit\\.com/((d/|get/)[A-Z0-9]{16}|file/(view/|download/)?[a-zA-Z0-9]{16}/.{1})" }, flags = { 0 })
