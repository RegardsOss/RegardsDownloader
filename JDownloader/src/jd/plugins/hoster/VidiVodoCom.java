...
@HostPlugin(revision = "$Revision: 28678 $", interfaceVersion = 2, names = { "vidivodo.com" }, urls = { "http://(www\\.)?(en\\.)?vidivodo\\.com/(video/[a-z0-9\\-]+/\\d+|VideoPlayerShare\\.swf\\?u=[A-Za-z0-9=]+)" }, flags = { 0 })
