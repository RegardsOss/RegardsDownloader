...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "lafiles.com" }, urls = { "https?://(www\\.)?lafiles\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class LaFilesCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://lafiles.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(lafiles\\.com)";
    ...
    // mods: login[Support for login-captcha (plaintext captcha)]
    ...
    public LaFilesCom(PluginWrapper wrapper) {
        super(wrapper);
