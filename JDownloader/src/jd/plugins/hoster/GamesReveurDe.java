...
@HostPlugin(revision = "$Revision: 32651 $", interfaceVersion = 2, names = { "games.reveur.de" }, urls = { "http://(www\\.)?games\\.reveur\\.de/(en|de)/[a-z0-9\\-]+/addons/[a-z0-9\\-]+/[a-z0-9\\-]+/[a-z0-9\\-]+/\\d+/[A-Za-z0-9\\-]+\\.html" }, flags = { 0 })
