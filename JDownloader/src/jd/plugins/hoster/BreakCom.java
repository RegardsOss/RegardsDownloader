 ...
 * @author typek_pb
 */
@HostPlugin(revision = "$Revision: 25244 $", interfaceVersion = 2, names = { "break.com" }, urls = { "http://(www\\.)?breakdecrypted\\.com/(index|usercontent|skittles|video)/[A-Za-z0-9\\-_/]+\\-\\d+$" }, flags = { 0 })
