...
@HostPlugin(revision = "$Revision: 18606 $", interfaceVersion = 2, names = { "file.qip.ru" }, urls = { "https?://(www\\.)?file\\.qip\\.ru/(download|get|file|document|photo|video|audio|mp3|office|rar|zip|archive|music)/[A-Za-z0-9]+/[^<>\"/]+\\.html" }, flags = { 0 })
