...
@HostPlugin(revision = "$Revision: 29235 $", interfaceVersion = 2, names = { "parelliconnect.com" }, urls = { "http://www\\.parelliconnect\\.com/ajax/resources/\\d+/(vault_display_video|vault_display_pdf)" }, flags = { 2 })
