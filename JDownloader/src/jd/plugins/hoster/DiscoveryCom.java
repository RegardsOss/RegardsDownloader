...
@HostPlugin(revision = "$Revision: 32583 $", interfaceVersion = 3, names = { "discovery.com", "tlc.com", "animalplanet.com" }, urls = { "http://discovery\\.comdecrypted\\d+", "http://tlc\\.comdecrypted\\d+", "http://animalplanet\\.comdecrypted\\d+" }, flags = { 2, 2, 2 })
