...
@HostPlugin(revision = "$Revision: 33447 $", interfaceVersion = 2, names = { "uploadc.ch", "uploadc.com" }, urls = { "https?://(?:www\\.)?uploadc\\.(?:com|ch)/(?:vidembed\\-)?[a-z0-9]{12}", "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsdgfd32424" }, flags = { 2, 0 })
