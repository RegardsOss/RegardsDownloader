...
@HostPlugin(revision = "$Revision: 33204 $", interfaceVersion = 2, names = { "uber-sha.re" }, urls = { "https?://(www\\.)?uber\\-sha\\.re/[A-Za-z0-9]+" }, flags = { 2 })
public class UberShaRe extends PluginForHost {
    ...
    private final String         domains                                      = "(uber\\-sha\\.re)";
