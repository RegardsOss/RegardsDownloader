...
@HostPlugin(revision = "$Revision: 32711 $", interfaceVersion = 2, names = { "arabloads.net", "arabloads.com" }, urls = { "https?://(www\\.)?arabloads\\.(com|net)/(vidembed\\-)?[a-z0-9]{12}", "fh65ih9bu459hj0hbjoerlgmloDELETE_MEfrvdehioefrwoihhgrteikopjnu56ijknobfgrnopik" }, flags = { 2, 0 })
