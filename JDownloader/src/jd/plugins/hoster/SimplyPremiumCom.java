...
@HostPlugin(revision = "$Revision: 33552 $", interfaceVersion = 3, names = { "simply-premium.com" }, urls = { "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsfs2133" }, flags = { 2 })
public class SimplyPremiumCom extends PluginForHost {
    ...
    public void showAccountDetailsDialog(final Account account) {
        ...
        if (ai != null) {
            ...
            String revision = "$Revision: 33552 $";
            try {
