...
@HostPlugin(revision = "$Revision: 33314 $", interfaceVersion = 3, names = { "bitvid.sx", "videoweed.es", "videoweed.com" }, urls = { "http://(?:www\\.)?(?:bitvid\\.sx|videoweed\\.(?:com|es)/(?:file/|embed\\.php\\?.*?v=|share\\.php\\?id=)|embed\\.videoweed\\.(?:com|es)/embed\\.php\\?v=)[a-z0-9]+", "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsdgfd32423", "REGEX_NOT_POSSIBLE_RANDOM-xjahyasbs" }, flags = { 2, 0 })
