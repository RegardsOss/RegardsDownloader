...
@HostPlugin(revision = "$Revision: 32711 $", interfaceVersion = 2, names = { "themediastorage.com", "thefileupload.com" }, urls = { "https?://(www\\.)?(thefileupload|themediastorage)\\.com/(vidembed\\-)?[a-z0-9]{12}", "REGEX_NOT_POSSIBLE_RANDOM-asdfasdfsadfsdgfd32423" }, flags = { 0, 0 })
