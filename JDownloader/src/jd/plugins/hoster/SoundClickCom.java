...
@HostPlugin(revision = "$Revision: 26395 $", interfaceVersion = 2, names = { "soundclick.com" }, urls = { "http://(www\\.)?soundclick\\.com/bands/page_songInfo\\.cfm\\?bandID=\\d+\\&songID=\\d+" }, flags = { 0 })
