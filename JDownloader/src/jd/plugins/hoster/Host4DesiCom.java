...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "host4desi.com" }, urls = { "http://(www\\.)?host4desi\\.com/[a-z0-9]{12}" }, flags = { 0 })
public class Host4DesiCom extends PluginForHost {

    private String              BRBEFORE            = "";

    private static final String PASSWORDTEXT        = "(<br><b>Password:</b> <input|<br><b>Passwort:</b> <input)";

    private static final String COOKIE_HOST         = "http://host4desi.com";

    private static final String MAINTENANCE         = ">This server is in maintenance mode";

    private static final String MAINTENANCEUSERTEXT = "This server is under Maintenance";

    public Host4DesiCom(PluginWrapper wrapper) {
        super(wrapper);
