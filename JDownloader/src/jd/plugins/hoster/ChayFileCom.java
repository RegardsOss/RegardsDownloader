...
@HostPlugin(revision = "$Revision: 33074 $", interfaceVersion = 3, names = { "chayfile.com" }, urls = { "https?://(www\\.)?chayfile\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class ChayFileCom extends PluginForHost {
    ...
    private static final String            COOKIE_HOST                  = "http://chayfile.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(chayfile\\.com|chayfile\\.biz|chayfile\\.org|chayfilez\\.com|chayfilz\\.com)";
    ...
    public ChayFileCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public String getDllink() {
        ...
        if (dllink == null) {
            ...
            if (dllink == null) {
                dllink = new Regex(correctedBR, "(\"|\\')(https?://[a-z0-9\\.\\-]+(:\\d{1,4})?/(files|d|cgi\\-bin/dl\\.cgi)/(\\d+/)?[a-z0-9]+/[^<>\"/]*?)(\"|\\')").getMatch(1);
            }
            if (dllink == null) {
