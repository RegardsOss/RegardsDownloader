...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 3, names = { "storagely.com" }, urls = { "https?://(www\\.)?storagely\\.com/((vid)?embed\\-)?[a-z0-9]{12}" }, flags = { 0 })
...
public class StoragelyCom extends PluginForHost {
     ...
     * */
    public StoragelyCom(PluginWrapper wrapper) {
        super(wrapper);
        setConfigElements();
