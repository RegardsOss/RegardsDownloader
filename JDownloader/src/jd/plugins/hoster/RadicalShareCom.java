...
@HostPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "radicalshare.com" }, urls = { "https?://(www\\.)?radicalshare\\.com/(vidembed\\-)?[a-z0-9]{12}" }, flags = { 2 })
public class RadicalShareCom extends PluginForHost {

    private String                         correctedBR                  = "";
    private String                         passCode                     = null;
    private static final String            PASSWORDTEXT                 = "<br><b>Passwor(d|t):</b> <input";
    /* primary website url, take note of redirects */
    private static final String            COOKIE_HOST                  = "http://radicalshare.com";
    private static final String            NICE_HOST                    = COOKIE_HOST.replaceAll("(https://|http://)", "");
    private static final String            NICE_HOSTproperty            = COOKIE_HOST.replaceAll("(https://|http://|\\.|\\-)", "");
    /* domain names used within download links */
    private static final String            DOMAINS                      = "(radicalshare\\.com)";
    ...
    // mods: checkErrors[Added another ipblocked text], login[Other account overview page]
    ...
    public RadicalShareCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void checkErrors(final DownloadLink theLink, final boolean checkAll) throws NumberFormatException, PluginException {
        ...
        if (new Regex(correctedBR, "(You have reached the download(\\-| )limit|You have to wait|class=\"err\">Don\\'t wait)").matches()) {
    ...
    private void login(final Account account, final boolean force) throws Exception {
        synchronized (LOCK) {
            try {
                ...
                if (!br.getURL().contains("/account.html")) {
                    getPage("/account.html");
                }
