...
@DecrypterPlugin(revision = "$Revision: 32227 $", interfaceVersion = 3, names = { "anime.thehylia.com" }, urls = { "http://(www\\.)?anime\\.thehylia\\.com/(downloads/series/|soundtracks/album/)[a-z0-9\\-_]+" }, flags = { 0 })
