...
@DecrypterPlugin(revision = "$Revision: 32575 $", interfaceVersion = 2, names = { "gametrailers.com" }, urls = { "http://(www\\.)?gametrailers\\.com/((video|user\\-movie)/[\\w\\-]+/\\d+|(full\\-episodes|reviews)/\\w+/[\\w\\-]+|videos/view/[\\w\\-]+/\\d+)" }, flags = { 0 })
