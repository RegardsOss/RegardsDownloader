...
@DecrypterPlugin(revision = "$Revision: 20458 $", interfaceVersion = 2, names = { "mangashare.com" }, urls = { "http://(www\\.)?read\\.mangashare\\.com/[A-Za-z0-9\\-_]+/chapter\\-\\d+/page\\d+\\.html" }, flags = { 0 })
