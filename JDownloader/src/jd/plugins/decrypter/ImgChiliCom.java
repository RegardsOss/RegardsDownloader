...
@DecrypterPlugin(revision = "$Revision: 33866 $", interfaceVersion = 2, names = { "imgchili.com" }, urls = { "http://((www\\.)?imgchili\\.(com|net)/show/|t\\d+\\.imgchili\\.(com|net)/)\\d+/[a-z0-9_\\.\\(\\)]+|http://(www\\.)?imgchili\\.(com|net)/album/[a-z0-9]{32}" }, flags = { 0 })
