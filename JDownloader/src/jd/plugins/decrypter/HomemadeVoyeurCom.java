...
@DecrypterPlugin(revision = "$Revision: 33823 $", interfaceVersion = 2, names = { "homemade-voyeur.com" }, urls = { "http://(?:www\\.)?homemade\\-voyeur\\.com/(?:(?:tube/)?video/|tube/gallery/|\\d+/)[A-Za-z0-9\\-]+\\.html" }, flags = { 0 })
