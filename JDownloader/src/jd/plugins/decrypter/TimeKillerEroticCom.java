...
@DecrypterPlugin(revision = "$Revision: 31977 $", interfaceVersion = 2, names = { "timekiller-erotic.com" }, urls = { "http://(www\\.)?timekiller\\-erotic\\.com/(Video/\\d+/.*?|PornHub/\\d+/[a-z0-9\\-_]+)\\.html" }, flags = { 0 })
public class TimeKillerEroticCom extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        if (parameter.matches("http://(www\\.)?timekiller\\-erotic\\.com/PornHub/\\d+/[a-z0-9\\-_]+\\.html")) {
            ...
            // xvideos.com 3
            externID = br.getRegex("xvideos\\.com/swf/flv_player_site_v\\d+\\.swf\".*?flashvars=\"id_video=(\\d+)\"").getMatch(0);
            if (externID != null) {
                decryptedLinks.add(createDownloadlink("http://www.xvideos.com/video" + externID));
                return decryptedLinks;
            }
