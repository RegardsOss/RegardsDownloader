...
@DecrypterPlugin(revision = "$Revision: 32366 $", interfaceVersion = 3, names = { "urlgalleries.net" }, urls = { "http://(www\\.)?[a-z0-9_]+\\.urlgalleries\\.net/blog_gallery\\.php\\?id=\\d+" }, flags = { 0 })
