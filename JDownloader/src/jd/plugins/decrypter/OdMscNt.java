...
@DecrypterPlugin(revision = "$Revision: 20708 $", interfaceVersion = 2, names = { "odimusic.net" }, urls = { "http://(www\\.)?odimusic\\.net/download/((music/|\\d+\\-).*?\\.html|engine/go\\.php\\?url=[a-zA-Z0-9% ]+)" }, flags = { 0 })
