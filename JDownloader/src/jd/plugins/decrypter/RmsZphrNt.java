...
@DecrypterPlugin(revision = "$Revision: 25425 $", interfaceVersion = 2, names = { "roms.zophar.net" }, urls = { "http://(www\\.)?zophar\\.net/(?!download_file|frontends|news\\-archive|consoles)[^<>\"/]*?/[^<>\"/]*?/[^<>\"/]*?\\.html" }, flags = { 0 })
