...
@DecrypterPlugin(revision = "$Revision: 30656 $", interfaceVersion = 2, names = { "mangapanda.com" }, urls = { "http://(www\\.)?mangapanda\\.com/([a-z0-9\\-]+/\\d+|\\d+\\-\\d+\\-1/[a-z0-9\\-]+/chapter\\-\\d+\\.html)" }, flags = { 0 })
