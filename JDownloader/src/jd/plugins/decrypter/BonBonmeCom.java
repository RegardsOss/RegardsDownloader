...
@DecrypterPlugin(revision = "$Revision: 30726 $", interfaceVersion = 3, names = { "bonbonme.com" }, urls = { "http://(www\\.)?((av|dl)\\.)?bonbonme\\.com/(?!makemoney|data/|forum/)[A-Za-z0-9\\-_]+/(?!list_)[A-Za-z0-9\\-_]+\\.html" }, flags = { 0 })
