...
@DecrypterPlugin(revision = "$Revision: 31950 $", interfaceVersion = 3, names = { "amateurdumper.com" }, urls = { "http://(www\\.)?amateurdumper\\.com/(index\\.php\\?ctr=view\\&id=\\d+|\\d+/.*?\\.html)" }, flags = { 0 })
