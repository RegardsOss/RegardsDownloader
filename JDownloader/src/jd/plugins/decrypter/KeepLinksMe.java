...
@DecrypterPlugin(revision = "$Revision: 33634 $", interfaceVersion = 3, names = { "kprotector.com", "keeplinks.me", "linkpacking.net" }, urls = { "https?://(www\\.)?kprotector\\.com/(p\\d*|d)/[a-z0-9]+", "https?://(www\\.)?keeplinks\\.(me|eu)/(p\\d*|d)/[a-z0-9]+", "http://(www\\.)?linkpacking\\.net/(p|d)/[a-z0-9]+" }, flags = { 0 })
