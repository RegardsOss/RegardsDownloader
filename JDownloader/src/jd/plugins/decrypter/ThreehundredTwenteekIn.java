...
@DecrypterPlugin(revision = "$Revision: 32970 $", interfaceVersion = 3, names = { "320k.in" }, urls = { "http://(www\\.)?320k\\.in/index\\.php\\?surf=(viewupload(\\&groupid=\\d*)?\\&uploadid=\\d+|redirect\\&url=[A-Za-z0-9 %=]+\\&uploadid=\\d+)" }, flags = { 0 })
