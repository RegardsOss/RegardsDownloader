...
@DecrypterPlugin(revision = "$Revision: 30268 $", interfaceVersion = 2, names = { "realitykings.com" }, urls = { "http://(?:www\\.)?members\\.(?:rk|realitykings)\\.com/\\?a=update\\.download\\&site=[a-z0-9]+\\&id=\\d+.+" }, flags = { 0 })
