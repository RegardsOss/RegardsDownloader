...
@DecrypterPlugin(revision = "$Revision: 33494 $", interfaceVersion = 2, names = { "javmon.com" }, urls = { "https?://(www\\.)?(javmon|jamo)\\.(com|tv)/(online\\-\\d+/)?(video|movie|clip)\\-\\d+(/|\\-)[a-z0-9\\-_]+\\.html" }, flags = { 0 })
