...
@DecrypterPlugin(revision = "$Revision: 32339 $", interfaceVersion = 3, names = { "8muses.com" }, urls = { "https?://(?:www\\.)?8muses\\.com/(?:index/category/[a-z0-9\\-_]+|album(?:/[a-z0-9\\-_]+){1,3})" }, flags = { 0 })
