...
@DecrypterPlugin(revision = "$Revision: 25014 $", interfaceVersion = 2, names = { "mangareader.net" }, urls = { "http://(www\\.)?mangareader\\.net/([a-z0-9\\-]+/\\d+|\\d+\\-\\d+\\-1/[a-z0-9\\-]+/chapter\\-\\d+\\.html)" }, flags = { 0 })
