...
@DecrypterPlugin(revision = "$Revision: 27074 $", interfaceVersion = 2, names = { "depositfiles.com" }, urls = { "https?://(www\\.)?(depositfiles\\.(com|org)|dfiles\\.(eu|ru))/([a-z]+/)?folders/.+" }, flags = { 0 })
