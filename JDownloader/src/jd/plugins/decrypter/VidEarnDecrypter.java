...
@DecrypterPlugin(revision = "$Revision: 29950 $", interfaceVersion = 2, names = { "videarn.com" }, urls = { "http://(www\\.)?((videarn|pornxs)\\.com/(video\\.php\\?id=|[a-z0-9\\-]+/)|embed\\.videarn\\.com/embed\\.php\\?id=)\\d+([a-z0-9\\-]+\\.html)?" }, flags = { 0 })
