...
@DecrypterPlugin(revision = "$Revision: 32492 $", interfaceVersion = 3, names = { "zippyshare.com" }, urls = { "http://(?:www\\.)?zippyshare\\.com/([a-z0-9\\-_%,]+/[a-z0-9\\-_%]+/dir\\.html|[a-z0-9A-Z_-]+)" }, flags = { 0 })
