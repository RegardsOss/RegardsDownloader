...
@DecrypterPlugin(revision = "$Revision: 25425 $", interfaceVersion = 2, names = { "break.com" }, urls = { "http://(www\\.)?(break\\.com/(index|usercontent|skittles|video)/[A-Za-z0-9\\-_/]+\\-\\d+$|break\\.com/embed/\\d+)" }, flags = { 0 })
