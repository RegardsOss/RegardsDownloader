...
@DecrypterPlugin(revision = "$Revision: 20458 $", interfaceVersion = 2, names = { "thekollection.com" }, urls = { "http://(www\\.)?((dubstep|electro|indie)\\.)?thekollection\\.com/(?!wp\\-includes|wp\\-content|category|about|contact|playlists|submit|artist)[\\w\\-]+/" }, flags = { 0 })
