...
@DecrypterPlugin(revision = "$Revision: 32094 $", interfaceVersion = 2, names = { "vosprotects.com" }, urls = { "http://(www\\.)?vosprotects\\.com/(linkcheck|linkidwoc)\\.php\\?linkid=[a-z0-9]+" }, flags = { 0 })
