...
@DecrypterPlugin(revision = "$Revision: 32655 $", interfaceVersion = 2, names = { "metacafe.com" }, urls = { "http://(www\\.)?metacafe\\.com/((watch|fplayer)/(sy\\-)?\\d+/.{1}|watch/yt\\-[A-Za-z0-9\\-_]+/.{1})" }, flags = { 0 })
