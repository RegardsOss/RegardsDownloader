...
@DecrypterPlugin(revision = "$Revision: 32245 $", interfaceVersion = 3, names = { "commons.wikimedia.org" }, urls = { "https?://commons\\.wikimedia\\.org/wiki/Category:Pictures_by_User:[A-Za-z0-9\\-_]+" }, flags = { 0 })
