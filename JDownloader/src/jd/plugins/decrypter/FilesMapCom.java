...
@DecrypterPlugin(revision = "$Revision: 22624 $", interfaceVersion = 2, names = { "filesmap.com" }, urls = { "http://(www\\.)?((es|ar|en|pt|ru|ja|de|fr|tr|pl)?\\.)?filesmap\\.com/(mp3/[A-Za-z0-9]+/[a-z0-9\\-]+|file/[A-Za-z0-9]+/[^<>\"/]+/[^<>\"/]+)" }, flags = { 0 })
