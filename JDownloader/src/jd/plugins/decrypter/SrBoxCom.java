...
@DecrypterPlugin(revision = "$Revision: 33869 $", interfaceVersion = 2, names = { "israbox.com" }, urls = { "https?://[\\w\\.]*(?:israbox\\.(?:com|net|org|info|me|download|eu|be|club)|isbox\\.net)/[0-9]+-.*?\\.html" }, flags = { 0 })
