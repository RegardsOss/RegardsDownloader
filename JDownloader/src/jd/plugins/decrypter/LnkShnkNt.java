 ...
 * @author raztoki
 */
@DecrypterPlugin(revision = "$Revision: 33508 $", interfaceVersion = 3, names = { "linkshrink.net" }, urls = { "https?://(?:www\\.)?linkshrink\\.net/([A-Za-z0-9]{5,6}|[A-Za-z0-9]{4}=(?:https?|ftp)://.+)" }, flags = { 0 })
