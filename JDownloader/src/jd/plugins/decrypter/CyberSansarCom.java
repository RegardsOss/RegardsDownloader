...
@DecrypterPlugin(revision = "$Revision: 23620 $", interfaceVersion = 2, names = { "cybersansar.com" }, urls = { "http://(www\\.)?cybersansar\\.com(\\.np)?/((ev_)?thumbnail_view\\.php\\?gal_id=\\d+|wallpaper_download\\.php\\?wid=\\d+|video_download\\.php\\?vid=\\d+)" }, flags = { 0 })
