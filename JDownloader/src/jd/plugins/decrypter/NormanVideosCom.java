...
@DecrypterPlugin(revision = "$Revision: 23767 $", interfaceVersion = 2, names = { "normanfaitdesvideos.com" }, urls = { "http://(www\\.)?normanfaitdesvideos\\.com/\\d{4}/\\d{2}/\\d{2}/[a-z0-9\\-]+/" }, flags = { 0 })
