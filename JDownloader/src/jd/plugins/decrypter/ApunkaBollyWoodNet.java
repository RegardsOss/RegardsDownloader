...
@DecrypterPlugin(revision = "$Revision: 25982 $", interfaceVersion = 2, names = { "apunkabollywood.net" }, urls = { "http://(www\\.)?apunkabollywood\\.(net|us)/browser/category/view/\\d+" }, flags = { 0 })
