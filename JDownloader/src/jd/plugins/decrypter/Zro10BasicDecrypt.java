...
@DecrypterPlugin(revision = "$Revision: 33809 $", interfaceVersion = 2, names = { "save-link.info" }, urls = { "https?://(?:www\\.)?(?:links-secure\\.com|save-link\\.info|share-link\\.info|h-link\\.us|foxmoviez\\.com|forexurl\\.net|forexbux\\.net|forexurls\\.net|zmelody\\.com|filmey\\.co|dualmarket\\.info|wwenews\\.us|[a-z0-9]+\\.arabseed\\.com)/[0-9]+" }, flags = { 0 })
