...
@DecrypterPlugin(revision = "$Revision: 33221 $", interfaceVersion = 2, names = { "moddb.com" }, urls = { "http://(www\\.)?moddb\\.com/(games|mods|engines|groups)/.*?/(addons|downloads)/[0-9a-z-]+" }, flags = { 0 })
