...
@DecrypterPlugin(revision = "$Revision: 20458 $", interfaceVersion = 2, names = { "freakshare.com" }, urls = { "http://(www\\.)?freakshare\\.(com|net)/(folder/\\d+/[^<>\"]+\\.html|\\?x=folder\\&f_id=\\d+\\&f_md5=[a-z0-9]+)" }, flags = { 0 })
