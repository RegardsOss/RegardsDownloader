...
@DecrypterPlugin(revision = "$Revision: 31950 $", interfaceVersion = 2, names = { "amateurgalore.net" }, urls = { "http://(www\\.)?amateurgalore\\.net/(index/video/[a-z0-9_\\-]+|[a-z]+/\\d+/[A-Za-z0-9\\-]+\\.html)" }, flags = { 0 })
