...
@DecrypterPlugin(revision = "$Revision: 20458 $", interfaceVersion = 2, names = { "mcanime.net" }, urls = { "http://(www\\.)?[a-z0-9]+\\.mcanime\\.net/manga_enlinea/[a-z0-9\\-_]+/realidad/\\d+/1" }, flags = { 0 })
