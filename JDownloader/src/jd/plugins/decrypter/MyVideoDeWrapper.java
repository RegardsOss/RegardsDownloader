...
@DecrypterPlugin(revision = "$Revision: 29857 $", interfaceVersion = 2, names = { "myvideo.de" }, urls = { "http://(www\\.)?myvideo\\.(de|at)/(watch/\\d+(/\\w+)?|[a-z0-9\\-/]+\\-m\\-\\d+|embed/(public/)?\\d+)" }, flags = { 0 })
public class MyVideoDeWrapper extends PluginForDecrypt {
    ...
    private static final String type_special = "http://(www\\.)?myvideo\\.de/[a-z0-9\\-/]+\\-m\\-\\d+";
