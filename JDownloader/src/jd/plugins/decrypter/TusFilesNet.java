...
@DecrypterPlugin(revision = "$Revision: 30563 $", interfaceVersion = 2, names = { "tusfiles.net" }, urls = { "https?://(www\\.)?(tusfiles\\.net/go/[a-z0-9]{12}/|j\\-b\\.tusfil\\.es/[A-Z0-9]+|tusfil(es\\.(net|co\\.nz)|\\.es)/d/[0-9A-Z]+)" }, flags = { 0 })
