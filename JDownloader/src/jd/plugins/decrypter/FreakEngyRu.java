...
@DecrypterPlugin(revision = "$Revision: 22006 $", interfaceVersion = 2, names = { "freakenergy.ru" }, urls = { "http://(www\\.)?freakenergy\\.ru/([a-z0-9\\-_]+\\.html|engine/go\\.php\\?url=[A-Za-z0-9%=]+)" }, flags = { 0 })
