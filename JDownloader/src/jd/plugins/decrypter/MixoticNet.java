...
@DecrypterPlugin(revision = "$Revision: 24087 $", interfaceVersion = 2, names = { "mixotic.net" }, urls = { "(http://(www\\.)?mixotic\\.net/dj\\-sets/.*)|(http://(www\\.)?mixotic\\.net/dj\\-mixes/.*)|(http://feedproxy\\.google\\.com/~r/mixotic/.*)" }, flags = { 0 })
