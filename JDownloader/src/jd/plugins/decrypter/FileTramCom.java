...
@DecrypterPlugin(revision = "$Revision: 22638 $", interfaceVersion = 2, names = { "filetram.com" }, urls = { "http://(www\\.)?filetram\\.com/(download/.+|(turbobit|uploading|netload|bitshare|rapidshare|mediafire|4shared)/[a-z0-9\\-_]+)" }, flags = { 0 })
