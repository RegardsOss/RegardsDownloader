...
@DecrypterPlugin(revision = "$Revision: 22776 $", interfaceVersion = 2, names = { "mymedia.yam.com" }, urls = { "http://(www\\.)?mymedia\\.yam\\.com/(m/\\d+|media_playlist_listcontent\\.php\\?pID=\\d+(\\&numrw=\\d+\\&)?|embed_playlist\\.swf\\?pID=\\d+)" }, flags = { 0 })
