...
@DecrypterPlugin(revision = "$Revision: 33335 $", interfaceVersion = 3, names = { "fora.tv" }, urls = { "http://(www\\.)?(library\\.)?fora\\.tv/\\d{4}/\\d{2}/\\d{2}/[A-Za-z0-9\\-_]+|http://library\\.fora\\.tv/program_landing\\.php\\?year=\\d{4}\\&month=\\d{2}\\&day=\\d{2}\\&title=[^<>\"/]+" }, flags = { 0 })
