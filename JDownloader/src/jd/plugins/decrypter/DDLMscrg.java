...
@DecrypterPlugin(revision = "$Revision: 32905 $", interfaceVersion = 2, names = { "ddl-music.to" }, urls = { "http://(?:www\\.)?ddl-music\\.(?:org|to)/(download/\\d+/.*?/|download/links/[a-z0-9]+/(mirror/\\d+/)?)" }, flags = { 0 })
