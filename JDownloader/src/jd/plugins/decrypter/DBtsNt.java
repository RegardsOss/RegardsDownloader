...
@DecrypterPlugin(revision = "$Revision: 22401 $", interfaceVersion = 2, names = { "audiobeats.net" }, urls = { "http://(www\\.)?audiobeats\\.net/((liveset|event|artist|link)\\?id=|link\\.php\\?id=)\\d+" }, flags = { 0 })
