...
@DecrypterPlugin(revision = "$Revision: 32846 $", interfaceVersion = 3, names = { "3dl.tv" }, urls = { "http://(www\\.)?(music|games|movies|serien|apps|porn)\\.3dl\\.tv/(download/\\d+/[^<>\"/]+/detail\\.html|folder/[a-z0-9]+)" }, flags = { 0 })
