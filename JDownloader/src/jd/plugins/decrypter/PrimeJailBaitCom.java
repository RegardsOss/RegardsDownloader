...
@DecrypterPlugin(revision = "$Revision: 31954 $", interfaceVersion = 3, names = { "primejailbait.com" }, urls = { "https?://(?:www\\.)?primejailbait\\.com/(id/\\d+|profile/[A-Za-z0-9\\-_]+(?:/fav/\\d+)?|setview/\\d+)/?$" }, flags = { 0 })
public class PrimeJailBaitCom extends PluginForDecrypt {
    ...
    private final String TYPE_SETVIEW      = "^https?://(?:www\\.)?primejailbait\\.com/setview/\\d+/?$";
