...
@DecrypterPlugin(revision = "$Revision: 30694 $", interfaceVersion = 3, names = { "music.163.com" }, urls = { "http://(www\\.)?music\\.163\\.com/(?:#/)?(?:album\\?id=|artist/album\\?id=|playlist\\?id=)\\d+" }, flags = { 0 })
