...
@DecrypterPlugin(revision = "$Revision: 20458 $", interfaceVersion = 2, names = { "telly.com" }, urls = { "http://(www\\.)?(telly|twitvid)\\.com/(?!awesome|post|best|funnyimpressions|http|https|index|javascript|redirect)[A-Z0-9]+" }, flags = { 0 })
