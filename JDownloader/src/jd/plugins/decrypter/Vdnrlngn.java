...
@DecrypterPlugin(revision = "$Revision: 33255 $", interfaceVersion = 2, names = { "video.uni-erlangen.de" }, urls = { "http://(www\\.)?video\\.uni\\-erlangen\\.de/(clip|course)/id/\\d+\\.html|http://(www\\.)?video\\.uni\\-erlangen\\.de/get/file/\\d+\\.html\\?src=download" }, flags = { 0 })
