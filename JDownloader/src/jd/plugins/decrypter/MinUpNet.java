...
@DecrypterPlugin(revision = "$Revision: 28356 $", interfaceVersion = 2, names = { "minup.net" }, urls = { "http://(www\\.)?minup\\.net/(?!about|api|contact|register|user|index|multiple|remote|login|forgot\\-password|contact|terms|dmca)[A-Za-z0-9]+" }, flags = { 0 })
