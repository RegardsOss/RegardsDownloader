...
@DecrypterPlugin(revision = "$Revision: 30339 $", interfaceVersion = 3, names = { "mangastream.com" }, urls = { "http://(www\\.)?(mangastream|readms)\\.com/(read|r)/([a-z0-9\\-_%\\+]+/){2}\\d+(\\?page=\\d+)?" }, flags = { 0 })
