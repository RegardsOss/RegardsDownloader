...
@DecrypterPlugin(revision = "$Revision: 33550 $", interfaceVersion = 3, names = { "xhamster.com" }, urls = { "http://(www\\.)?((de|es|ru|fr|it|jp|pt|nl|pl)\\.)?xhamster\\.com/photos/gallery/[0-9]+/.*?\\.html" }, flags = { 0 })
