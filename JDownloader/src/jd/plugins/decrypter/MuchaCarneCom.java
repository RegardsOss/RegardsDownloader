...
@DecrypterPlugin(revision = "$Revision: 32901 $", interfaceVersion = 3, names = { "muchacarne.xxx" }, urls = { "http://(www\\.)?muchacarne\\.(com|xxx)/hosted(\\-id\\d+\\-.*?\\.html|/media/[a-z0-9\\-]+,\\d+\\.php)" }, flags = { 0 })
