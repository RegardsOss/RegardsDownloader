...
@DecrypterPlugin(revision = "$Revision: 31853 $", interfaceVersion = 3, names = { "uploadmagnet.com" }, urls = { "https?://(www\\.)?(multi\\.hotshare\\.biz|uploadmagnet\\.com|pdownload\\.net|zlinx\\.me|filesuploader\\.com|onmirror\\.com|multiupload\\.biz|mirrorhive\\.com|multimirrorupload\\.com)/([a-z0-9]{1,2}_)?[a-z0-9]{12}" }, flags = { 0 })
