...
@DecrypterPlugin(revision = "$Revision: 28545 $", interfaceVersion = 2, names = { "vcrypt.net" }, urls = { "http://(www\\.)?vcrypt\\.net/[a-z0-9]{6}" }, flags = { 0 })
public class VcryptNet extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        if (br.containsHTML(">Error folder unavailable<")) {
