...
@DecrypterPlugin(revision = "$Revision: 32821 $", interfaceVersion = 2, names = { "ctdisk.com" }, urls = { "https?://(www\\.)?((ctdisk|400gb|pipipan|t00y)\\.com|bego\\.cc)/u/\\d{6,7}(/\\d{6,7})?" }, flags = { 0 })
