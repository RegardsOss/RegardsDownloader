...
@DecrypterPlugin(revision = "$Revision: 23191 $", interfaceVersion = 2, names = { "chauthanh.info" }, urls = { "http://[\\w\\.]*?chauthanh\\.info/(animeDownload/anime/.*?|anime/view/[a-z0-9\\-]+)\\.html" }, flags = { 0 })
