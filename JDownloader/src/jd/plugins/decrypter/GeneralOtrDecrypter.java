...
@DecrypterPlugin(revision = "$Revision: 33200 $", interfaceVersion = 2, names = { "tivootix.co.cc", "otr.seite.com" }, urls = { "http://(www\\.)?tivootix\\.co\\.cc/\\?file=[^<>\"\\']+", "http://(www\\.)?otr\\.seite\\.com/get\\.php\\?file=[^<>\"\\']+" }, flags = { 0, 0 })
