...
@DecrypterPlugin(revision = "$Revision: 31977 $", interfaceVersion = 2, names = { "stolenvideos.net" }, urls = { "http://(?:www\\.)?stolenvideos\\.net/(tube/video/[a-z0-9\\-]+\\-[A-Za-z0-9]+\\.html|\\d+/[A-Za-z0-9\\-_]+\\.html)" }, flags = { 0 })
