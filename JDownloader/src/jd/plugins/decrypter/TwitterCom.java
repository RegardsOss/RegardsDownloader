...
@DecrypterPlugin(revision = "$Revision: 33351 $", interfaceVersion = 3, names = { "twitter.com", "t.co" }, urls = { "https?://(www\\.|mobile\\.)?twitter\\.com/[A-Za-z0-9_\\-]+/(media|status/\\d+[^\\s]*)|https://twitter\\.com/i/cards/tfw/v1/\\d+", "https?://t\\.co/[a-zA-Z0-9]+" }, flags = { 0, 0 })
    ...
    public ArrayList<DownloadLink> decryptIt(CryptedLink param, ProgressController progress) throws Exception {
        ...
        if (parameter.matches(TYPE_CARD)) {
            ...
            do {
                ...
                final String[] tweetsources = this.br.getRegex("li class=\"js-stream-item stream-item stream-item expanding-stream-item(.*?)ProfileTweet\\-actionCount").getColumn(0);
