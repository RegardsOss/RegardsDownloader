...
@DecrypterPlugin(revision = "$Revision: 32715 $", interfaceVersion = 2, names = { "anime-stream24.com" }, urls = { "http://(www\\.)?(anime\\-stream24\\.(com|tv)/\\d+/\\d+/.*?|anime\\-stream24\\.info/s/[a-z0-9]+/[a-z0-9]+_\\d+)\\.html" }, flags = { 0 })
