...
@DecrypterPlugin(revision = "$Revision: 24304 $", interfaceVersion = 2, names = { "filehippo.com" }, urls = { "http://(www\\.)?update\\.filehippo\\.com(/(es|en|pl|jp|de))?/update/check/[a-z0-9\\-]+/detailed" }, flags = { 0 })
