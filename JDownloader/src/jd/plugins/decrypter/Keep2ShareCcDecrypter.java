...
@DecrypterPlugin(revision = "$Revision: 30341 $", interfaceVersion = 2, names = { "keep2share.cc" }, urls = { "https?://(www\\.)?(keep2share|k2s|k2share|keep2s|keep2)\\.cc/file/(info/)?[a-z0-9]+" }, flags = { 0 })
