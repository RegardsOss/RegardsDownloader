...
@DecrypterPlugin(revision = "$Revision: 32802 $", interfaceVersion = 2, names = { "animea.net" }, urls = { "http://((www\\.)?animea\\.net/download/[\\d\\-]+/[\\w\\-]+episode\\-[\\d\\.]+\\.html|manga\\.animea\\.net/[\\w\\-]+chapter\\-[\\d\\.]+(\\-page\\-[\\d\\.]+)?\\.html)" }, flags = { 0 })
