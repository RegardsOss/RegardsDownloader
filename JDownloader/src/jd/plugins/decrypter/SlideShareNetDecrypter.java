...
@DecrypterPlugin(revision = "$Revision: 31350 $", interfaceVersion = 3, names = { "slideshare.net" }, urls = { "http://(?:(?:www|es|de|fr|pt)\\.)?slideshare\\.net/(?!search|business)[a-z0-9\\-_]+/[a-z0-9\\-_]+" }, flags = { 0 })
