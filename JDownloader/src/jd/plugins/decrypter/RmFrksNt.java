...
@DecrypterPlugin(revision = "$Revision: 23507 $", interfaceVersion = 2, names = { "rom-freaks.net" }, urls = { "http://(www\\.)?rom\\-freaks\\.net/(download\\-[0-9]+\\-file\\-.+|link\\-[0-9]\\-[0-9]+\\-file\\-.+|.+desc\\-name.+)\\.html" }, flags = { 0 })
