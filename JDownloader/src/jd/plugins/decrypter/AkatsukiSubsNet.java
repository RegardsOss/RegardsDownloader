...
@DecrypterPlugin(revision = "$Revision: 28832 $", interfaceVersion = 2, names = { "akatsuki-subs.net" }, urls = { "http://(www\\.)?akatsuki\\-subs\\.net/(projekte/(laufend|abgeschlossen)/[a-z0-9\\-]+/|\\d+/releases/[a-z0-9]+/[a-z0-9\\-]+\\-\\d+/)" }, flags = { 0 })
