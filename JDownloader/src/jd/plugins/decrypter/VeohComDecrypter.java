...
@DecrypterPlugin(revision = "$Revision: 21936 $", interfaceVersion = 2, names = { "veoh.com" }, urls = { "http://(www\\.)?veoh\\.com/((browse/videos/category/.*?/)?watch/[A-Za-z0-9]+|videos/[A-Za-z0-9]+)" }, flags = { 0 })
