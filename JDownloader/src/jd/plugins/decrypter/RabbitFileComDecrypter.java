...
@DecrypterPlugin(revision = "$Revision: 26134 $", interfaceVersion = 2, names = { "rabbitfile.com" }, urls = { "http://(www\\.)?rabbitfile\\.com/(download_regular\\.php\\?file=|dl\\.php\\?f=)[A-Za-z0-9]+" }, flags = { 0 })
