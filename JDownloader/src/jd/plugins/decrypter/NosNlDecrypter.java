...
@DecrypterPlugin(revision = "$Revision: 28979 $", interfaceVersion = 2, names = { "nos.nl" }, urls = { "http://(www\\.)?nos\\.nl/(video/[A-Za-z0-9\\-_]+\\.html|/?embed/\\?id=v:\\d+|uitzendingen/(lq/)?\\d+)" }, flags = { 0 })
