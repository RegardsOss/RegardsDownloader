...
@DecrypterPlugin(revision = "$Revision: 32981 $", interfaceVersion = 2, names = { "ebook-hell.to" }, urls = { "https?://(www\\.)?ebook\\-hell\\.to/(category/[A-Za-z0-9\\-]+/[A-Za-z0-9\\-]+\\.html|\\?id=\\d+)" }, flags = { 0 })
