...
@DecrypterPlugin(revision = "$Revision: 30829 $", interfaceVersion = 2, names = { "nk.pl" }, urls = { "http://(www\\.)?nk\\.pl/#?profile/\\d+/gallery(/album/\\d+(/\\d+)?|/\\d+|#(!|%21)(q(\\?|%3F))*?album(=|%3D)\\d+|\\?src=profile_(box_see_more|button)#(!|%21)album(=|%3D)\\d+)?" }, flags = { 0 })
